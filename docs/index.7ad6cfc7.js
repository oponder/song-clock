...
[["C","Am"],["G","Em"],["D","Bm"],["A","F#m"],["E","C#m"],["B","G#m"],["F#","D#m"],["C#","A#m"],["Ab","Fm"],["Eb","Cm"],["Bb","Gm"],["F","Dm"]].forEach((e,t)=>{let r=document.createElement("div");r.classList.add("key"),r.id="key-"+t,r.innerHTML=e[0]+" / "+e[1],circleArea.appendChild(r)}),new Date().getTime();let e=window.innerWidth;addEventListener("resize",t=>{e=window.innerWidth}),// Call the animate function to start the animation loop
...
requestAnimationFrame(t)}();//# sourceMappingURL=index.7ad6cfc7.js.map

//# sourceMappingURL=index.7ad6cfc7.js.map
