...
[["C","Am"],["G","Em"],["D","Bm"],["A","F#m"],["E","C#m"],["B","G#m"],["F#","D#m"],["C#","A#m"],["Ab","Fm"],["Eb","Cm"],["Bb","Gm"],["F","Dm"]].forEach(e=>{let t=document.createElement("div");t.classList.add("key"),t.innerHTML=e[0]+" / "+e[1],circleArea.appendChild(t)}),new Date().getTime(),e=window.innerWidth,addEventListener("resize",t=>{e=window.innerWidth}),// Call the animate function to start the animation loop
...
requestAnimationFrame(t)}();//# sourceMappingURL=index.0614b0c0.js.map

//# sourceMappingURL=index.0614b0c0.js.map
